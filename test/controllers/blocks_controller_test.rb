...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { adjudicado: @block.adjudicado, fecha: @block.fecha } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { adjudicado: @block.adjudicado, fecha: @block.fecha } }
